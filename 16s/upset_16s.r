...
png("Figure 1c. Upset_Organ_material (16s).png",  width = 15, height = 10, units = "in", res = 300)
...
png("Figure 6c. Upset_Season (16s).png",  width = 15, height = 10, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 22, fontface="italic"),
	top_annotation = upset_top_annotation(upset_data, 
...
png("Figure 9c. Upset_Plant(16s).png",  width = 22, height = 10, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 22, fontface="italic"),
	top_annotation = upset_top_annotation(upset_data, 
