...
physeq_factors = physeq_factors[!physeq_factors == "c__Sphingobacteriia"]
physeq_factors = c("c__Sphingobacteriia", physeq_factors)
physeq_factors = cbind(physeq_factors, c("#9932cc", rev(mycolors[1:length(physeq_factors)-1])))
...
# Figure. Class level barplot among plant organs (16S)
ggplot(Spspl) +
...
ggsave("Figure 1b. barplot_Class_Organ_16S (sow).png", width = 15, height = 15)
