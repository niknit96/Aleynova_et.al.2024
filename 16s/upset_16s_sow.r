...
physeq = merge_samples(physeq_16s_sow, "Organ_material")
...
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="Table S4.txt")
#
...
# Figure Upset Organ_material (16s)
png("Figure 1d. Figure_Upset_Organ_material (16s) sow.png",  width = 15, height = 10, units = "in", res = 300)
