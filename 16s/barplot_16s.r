...
ggsave("Figure 6a. barplot_Class_Season_16S.png", width = 10, height = 15)
#
...
ggsave("Figure 9a. barplot_Class_Plant_16s.png", width = 15, height = 15)
