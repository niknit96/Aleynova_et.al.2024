...
ggsave("Figure 3a. barplot_Class_Organ_ITS.png", width = 13, height = 15)
...
ggsave("Figure 6b. barplot_Class_Season_ITS.png", width = 10, height = 15)
#
...
ggsave("Figure 9b. barplot_Class_Plant_ITS.png", width = 15, height = 15)
