...
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="Table S5.txt")
#
...
png("Figure 3c. Upset_Organ_material (ITS).png",  width = 15, height = 10, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	...
	top_annotation = upset_top_annotation(upset_data, 
		...
		add_numbers = TRUE, 
		numbers_gp = gpar(fontsize = 20)),
    right_annotation = upset_right_annotation(upset_data, 
		add_numbers = TRUE, 
		axis_param = list(gp = gpar(fontsize = 17)),
		annotation_name_gp = gpar(fontsize = 17),
		numbers_gp = gpar(fontsize = 17)))
draw(upset_plot)
dev.off()
...
colnames(Upset_genus_.txt) = c("Taxa of genus level", "Where present")
Upset_genus_.txt = as.data.frame(Upset_genus_.txt)
write.table(Upset_genus_.txt, sep = "\t", row.names = FALSE, quote = FALSE, file="Table S10.txt")
#
...
png("Figure 6d. Upset_Season (ITS).png",  width = 15, height = 10, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 22, fontface="italic"),
	top_annotation = upset_top_annotation(upset_data, 
...
png("Figure 9d. Upset_Plant(ITS).png",  width = 22, height = 10, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 22, fontface="italic"),
	top_annotation = upset_top_annotation(upset_data, 
