...
png("Figure 3c. Upset_Organ_material (ITS).png",  width = 13, height = 8, units = "in", res = 300)
...
png("Figure 6d. Upset_Season (ITS).png",  width = 13, height = 8, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 20, fontface="italic"),
	 	top_annotation = upset_top_annotation(upset_data, 
...
png("Figure 9d. Upset_Plant(ITS).png",  width = 18, height = 8, units = "in", res = 300)
upset_plot = UpSet(upset_data, 
	comb_col = upset_colors, 
    row_names_gp = gpar(fontsize = 20, fontface="italic"),
 	top_annotation = upset_top_annotation(upset_data, 
