...
Spspl$Class = factor(Spspl$Class, levels = c("c__Mucoromycotina", Barplot_factors[, "Class"]))
...
ggplot(Spspl) +
	...
	scale_fill_manual(values = c("#aed7ea", Barplot_factors[, "color"])) +
...
ggsave("Figure 3b. barplot_Class_Organ_ITS (sow).png", width = 13, height = 15)
